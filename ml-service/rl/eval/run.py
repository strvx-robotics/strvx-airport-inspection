...
trend point — the "ticket quality" number Langfuse would later chart:
    ...
    python -m rl.eval.run            # quality of the current writer
    python -m rl.eval.run --n 2 --limit 4
"""
...
from rl.eval import judge
from rl.eval.eval_set import eval_contexts
from rl.reward_model import RewardModel
from rl.serve import DraftReq, _context, _generate, _template
...
def _selfcheck() -> None:
    import rl.eval.run as R
    from rl.eval import judge as J
