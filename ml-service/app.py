...
Run locally:  uvicorn app:app --port 8000   (after `pip install -r requirements.txt`)
"""
...
from rl.serve import register as register_rl  # noqa: E402  (after app is defined)

register_rl(app)

# Live detection relay: WS /live/ws/{runway} (browsers) + POST /live/detections (worker)
from relay import register_relay  # noqa: E402
