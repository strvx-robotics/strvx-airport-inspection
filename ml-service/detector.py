...
def build_default_detector() -> RunwayDetector:
    ...
    # Per-category default weights (fetched by download_models.py / baked into the
    ...
    default_paths = {
        "pavement": "models/pavement.pt",
        "marking": "models/marking.pt",
        "lighting": "models/lighting.pt",
    }
